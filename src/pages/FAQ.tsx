  ...
  const faqs = [
    {
      ...
      answer:
        "Naba is an AI-powered inventory management and forecasting system designed to help companies understand their stock needs, reduce losses, and make better inventory decisions.",
    },
    {
      question: "How can companies benefit from it?",
      answer:
        "By subscribing with Naba, companies receive accurate demand forecasting, inventory optimization insights, predictive analytics that support smarter decision-making, reduce losses, and save time.",
    },
    {
      question: "What features do you offer?",
      answer:
        "We offer: Core Feature: AI-powered demand forecasting with lead-time and shipping prediction, Smart inventory optimization, Data integration, and Scenario simulation what-if analysis.",
    },
    {
      question: "How accurate is your model?",
      answer:
        "Our AI model achieved 94% accuracy based on real data, continuous monitoring, and automatic retraining.",
    },
    {
      question: "Who can use Naba?",
      answer:
        "Retailers, warehouses, distributors, manufacturers, and any business that manages inventory or supply chains.",
    },
    {
      question: "How do subscriptions work?",
      answer:
        "Companies choose a plan, create an account, connect their data, and activate the features they need.",
    },
    {
      question: "Is our data safe?",
      answer:
        "Yes. All data is handled securely and used only for generating insights and forecasts.",
    },
  ];
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <div className="w-20 h-20 sphere-gradient rounded-full flex items-center justify-center mx-auto mb-8 shadow-[0_0_60px_rgba(245,196,0,0.4)]">
              <HelpCircle
                className="w-10 h-10 text-[#001F3F]"
                strokeWidth={2.5}
              />
            </div>
